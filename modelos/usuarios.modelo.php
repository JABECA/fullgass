...
class ModeloUsuarios{
	...
	static public function mdlIngresarUsuario($tabla, $datos){
		...
		$tabla(nombre, identificacion, telefono, usuario, password, perfil, foto, contacto, numero_contacto, estado) 

		values(:nombre, :identificacion, :telefono, :usuario, :password, :perfil, :foto, :contacto, :numero_contacto, :estado)");
	...
	static public function mdlEditarUsuario($tabla, $datos){ 
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, identificacion = :identificacion, telefono = :telefono, usuario = :usuario, password = :password, perfil = :perfil, foto = :foto, contacto = :contacto, numero_contacto = :numero_contacto WHERE id= :id ");
